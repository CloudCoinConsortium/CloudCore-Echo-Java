...
public class CommandInterpreter {
        ...
        while (!restart) {
            ...
            switch (commandRecieved.toLowerCase()) {
                ...
                case "db test":
                    setRaidaTestStatus();
                    for (int i = 0; i < 25; i++) {
                        System.out.println("RAIDA" + i + ": " + raidaArray[i].testStatus + ", ms:" + raidaArray[i].ms);
                    }//end for each raida status
                    break;
                ...
                case "import":
                    ...
                    for (int j = 0; j < incomeFileNames.length; j++) {
                        ...
                        for (int i = 0; i < 25; i++) {
                            if (i % 5 == 0) {
                                System.out.println("");
                            }//Give every five statuses a line break
    ...
    public static void changeState(String newState) {
        ...
        switch (newState) {
            ...
            case "bank":
                nextState = stateManager.currentState.getExit("bank");
                ...
                break;
            case "import":
                nextState = stateManager.currentState.getExit("import");
                break;
            case "start":
            ...
            case "founder":
                ...
                break;
            case "fracked":
                nextState = stateManager.currentState.getExit("fracked");
                break;
        }//end switch
    ...
    */
    ...
    public static String sortCoin(CloudCoin coin, int RAIDAHealth) {
        ...
        if (coin.hp > 24 && RAIDAHealth > 11) {//No Problems Move to Bank
            ...
            returnString = "bank";
        } else if (coin.hp > 9) {//Can be fixed
